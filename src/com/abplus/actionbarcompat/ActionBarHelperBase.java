...
package com.abplus.actionbarcompat;
...
public class ActionBarHelperBase extends ActionBarHelper {
    ...
    private void setupActionBar() {
        ...
        SimpleMenuItem homeItem = new SimpleMenuItem(
                tempMenu, android.R.id.home, 0, mActivity.getString(R.string.abc_app_name));
        homeItem.setIcon(R.drawable.abc_ic_home);
    ...
    public void setRefreshActionItemState(boolean refreshing) {
        View refreshButton = mActivity.findViewById(R.id.abc_item_refresh);
        View refreshIndicator = mActivity.findViewById(
                R.id.abc_item_refresh_progress);
    ...
    protected void onTitleChanged(CharSequence title, int color) {
        TextView titleView = (TextView) mActivity.findViewById(R.id.abc_title);
        if (titleView != null) {
    ...
    private ViewGroup getActionBarCompat() {
        return (ViewGroup) mActivity.findViewById(R.id.abc_actionbar);
    }
     ...
     * {@link com.abplus.actionbarcompat.ActionBarHelperBase#setRefreshActionItemState(boolean)}.
     */
    private View addActionItemCompatFromMenuItem(final MenuItem item) {
        ...
        actionButton.setLayoutParams(new ViewGroup.LayoutParams(
                (int) mActivity.getResources().getDimension(
                        itemId == android.R.id.home
                                ? R.dimen.abc_button_home_width
                                : R.dimen.abc_button_width),
                ViewGroup.LayoutParams.MATCH_PARENT));
        if (itemId == R.id.abc_menu_refresh) {
            actionButton.setId(R.id.abc_item_refresh);
        }
        ...
        if (item.getItemId() == R.id.abc_menu_refresh) {
            ...
            final int progressIndicatorHeight = buttonWidth / 2;
            ...
            indicator.setId(R.id.abc_item_refresh_progress);
